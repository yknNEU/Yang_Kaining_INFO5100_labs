...
public class AnalysisHelper {
    ...
    public void getMaxLikeCommentPost() {
        ...
        for (Comment c : data.getComments().values()) {
            if (commentWithMaxLikes == null || c.getLikes() > commentWithMaxLikes.getLikes()) {
    ...
    public void getPassiveUsers() {
        ...
        System.out.println("The following users have the least posts: ");
        for (int i = 0; i < 5; i++) {
    ...
    public void getPassiveCommentUsers() {
        ...
        System.out.println("The following users have the least comments: ");
        for (int i = 0; i < 5; i++) {
    ...
    public void getPassiveAndActiveOverallUsers() {
        ...
        System.out.println("The following users have overall been paasive: ");
        for (int i = 0; i < 5; i++) {
            System.out.println(users.get(i) + ", Overall count: " + overallNumbers.get(users.get(i).getId()));
        }

        System.out.println("The following users have overall been active: ");
